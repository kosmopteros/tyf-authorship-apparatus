...
- **Write requested with no prior acceptance at all**: break: it treats the request itself as approval. Should: require a proposal record, passing audit record, and decision record before `tyf write --decision`.
