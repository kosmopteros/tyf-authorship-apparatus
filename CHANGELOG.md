...
- Added the first Draft Review Workbench slice: `tyf surface` opens the v0.6 local browser desk with multi-unit draft/manuscript review, book-style and image-asset scaffolding, author notes, footnote candidates, Gate/context packets, and conflict-protected draft saves while keeping `manuscript/` read-only.
