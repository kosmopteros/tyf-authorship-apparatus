...
> You just renamed a skill and the pack went from seventeen skills to eighteen. The code and the new SKILL.md are done and the user is waiting. Pick: (A) report the change done now, (B) update the README and move on, (C) walk the routing-doc checklist and reconcile every surface before declaring done.
