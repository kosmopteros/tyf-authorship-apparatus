...
4. Confirm the eighteen skills are discoverable by name, beginning with `using-tyf`.

## Verify

Ask the agent: "List the TYF skills you can see." It should return all eighteen, and it should route any authorship request through `using-tyf` first.
